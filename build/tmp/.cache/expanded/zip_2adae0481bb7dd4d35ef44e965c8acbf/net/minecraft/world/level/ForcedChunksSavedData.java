...
public class ForcedChunksSavedData extends SavedData {
    ...
    public static ForcedChunksSavedData load(CompoundTag pTag, HolderLookup.Provider pRegistries) {
        var ret = new ForcedChunksSavedData(new LongOpenHashSet(pTag.getLongArray("Forced")));
        net.minecraftforge.common.world.ForgeChunkManager.readForgeForcedChunks(pTag, ret.blockForcedChunks, ret.entityForcedChunks);
        return ret;
    }
