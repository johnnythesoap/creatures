    ...
    public static GameTestServer create(
        ...
        if (pTestBatches.isEmpty()) {
            ...
            WorldDataConfiguration worlddataconfiguration = new WorldDataConfiguration(
                new DataPackConfig(new ArrayList<>(pPackRepository.getSelectedIds()), List.of()), ENABLED_FEATURES // Forge: Use the selected datapacks as this takes sorting into account.
            );
