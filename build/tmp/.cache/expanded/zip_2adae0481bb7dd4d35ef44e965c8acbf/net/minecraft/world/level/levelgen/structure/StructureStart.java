...
public final class StructureStart {
    ...
    public CompoundTag createTag(StructurePieceSerializationContext pContext, ChunkPos pChunkPos) {
        ...
        if (this.isValid()) {
            if (pContext.registryAccess().lookupOrThrow(Registries.STRUCTURE).getKey(this.getStructure()) == null) { // FORGE: This is just a more friendly error instead of the 'Null String' below
