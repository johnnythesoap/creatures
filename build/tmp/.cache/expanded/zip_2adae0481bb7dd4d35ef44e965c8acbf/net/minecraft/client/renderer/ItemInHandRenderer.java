        ...
        if (!pPlayer.isScoping()) {
            ...
            if (pStack.isEmpty()) {
                ...
                if (pPlayer.isUsingItem() && pPlayer.getUseItemRemainingTicks() > 0 && pPlayer.getUsedItemHand() == pHand) {
                    ...
                    float f1 = f / (float)CrossbowItem.getChargeDuration(pStack, pPlayer);
                    if (f1 > 1.0F) {
                        f1 = 1.0F;
                    }
                    ...
                    switch (pStack.getUseAnimation()) {
                        ...
                        case BLOCK:
                            ...
                            if (!(pStack.getItem() instanceof ShieldItem)) {
                                pPoseStack.translate((float)j * -0.14142136F, 0.08F, 0.14142136F);
                                pPoseStack.mulPose(Axis.XP.rotationDegrees(-102.25F));
                                pPoseStack.mulPose(Axis.YP.rotationDegrees((float)j * 13.365F));
                                pPoseStack.mulPose(Axis.ZP.rotationDegrees((float)j * 78.05F));
                            }
                            break;
                        case BOW:
                            this.applyItemArmTransform(pPoseStack, humanoidarm, pEquippedProgress);
                            pPoseStack.translate((float)j * -0.2785682F, 0.18344387F, 0.15731531F);
                            pPoseStack.mulPose(Axis.XP.rotationDegrees(-13.935F));
                            pPoseStack.mulPose(Axis.YP.rotationDegrees((float)j * 35.3F));
                            pPoseStack.mulPose(Axis.ZP.rotationDegrees((float)j * -9.785F));
                            float f6 = (float)pStack.getUseDuration(pPlayer) - ((float)pPlayer.getUseItemRemainingTicks() - pPartialTicks + 1.0F);
                            float f8 = f6 / 20.0F;
                        ...
                        case SPEAR:
                            this.applyItemArmTransform(pPoseStack, humanoidarm, pEquippedProgress);
                            pPoseStack.translate((float)j * -0.5F, 0.7F, 0.1F);
                            pPoseStack.mulPose(Axis.XP.rotationDegrees(-55.0F));
                            pPoseStack.mulPose(Axis.YP.rotationDegrees((float)j * 35.3F));
                            pPoseStack.mulPose(Axis.ZP.rotationDegrees((float)j * -9.785F));
                            float f5 = (float)pStack.getUseDuration(pPlayer) - ((float)pPlayer.getUseItemRemainingTicks() - pPartialTicks + 1.0F);
                            float f7 = f5 / 10.0F;
                            if (f7 > 1.0F) {
                                f7 = 1.0F;
                            }
                            ...
                            if (f7 > 0.1F) {
                                ...
                                float f11 = f7 - 0.1F;
                                float f13 = f9 * f11;
                                pPoseStack.translate(f13 * 0.0F, f13 * 0.004F, f13 * 0.0F);
                            }

                            pPoseStack.translate(0.0F, 0.0F, f7 * 0.2F);
                            pPoseStack.scale(1.0F, 1.0F, 1.0F + f7 * 0.2F);
                            pPoseStack.mulPose(Axis.YN.rotationDegrees((float)j * 45.0F));
                            break;
                        case BRUSH:
