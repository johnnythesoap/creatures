...
public class LiquidBlockRenderer {
    ...
    public void tesselate(BlockAndTintGetter pLevel, BlockPos pPos, VertexConsumer pBuffer, BlockState pBlockState, FluidState pFluidState) {
        ...
        boolean flag2 = shouldRenderFace(pFluidState, pBlockState, Direction.DOWN, fluidstate) && !isFaceOccludedByNeighbor(Direction.DOWN, 0.8888889F, blockstate);
        boolean flag3 = shouldRenderFace(pFluidState, pBlockState, Direction.NORTH, fluidstate2);
        boolean flag4 = shouldRenderFace(pFluidState, pBlockState, Direction.SOUTH, fluidstate3);
        boolean flag5 = shouldRenderFace(pFluidState, pBlockState, Direction.WEST, fluidstate4);
        boolean flag6 = shouldRenderFace(pFluidState, pBlockState, Direction.EAST, fluidstate5);
        if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
            ...
            for (Direction direction : Direction.Plane.HORIZONTAL) {
                ...
                if (flag7 && !isFaceOccludedByNeighbor(direction, Math.max(f44, f45), pLevel.getBlockState(pPos.relative(direction)))) {
