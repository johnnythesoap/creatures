...
public class ModelBlockRenderer {
    ...
    public void tesselateWithAO(
        ...
        for (Direction direction : DIRECTIONS) {
            ...
            if (!list.isEmpty()) {
                ...
                if (!p_111085_ || Block.shouldRenderFace(p_111081_, p_111079_.getBlockState(blockpos$mutableblockpos), direction)) {
    ...
    public void tesselateWithoutAO(
        ...
        for (Direction direction : DIRECTIONS) {
            ...
            if (!list.isEmpty()) {
                ...
                if (!p_111097_ || Block.shouldRenderFace(p_111093_, p_111091_.getBlockState(blockpos$mutableblockpos), direction)) {
    ...
    static class AmbientOcclusionFace {
        ...
        public void calculate(
            ...
            if (pShapeFlags.get(0) || !blockstate9.isSolidRender()) {
